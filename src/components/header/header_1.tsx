   ...
   return (
    <header className={styles.container}>
        <section className={styles.headerSection} >
            ...
            <h1>At carefinder, we connect you with health care services around you</h1>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas necessitatibus animi distinctio minus, deserunt impedit.</p>
            </div>
